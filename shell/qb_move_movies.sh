...
# 默认源目录路径和目标目录路径
default_source_directory="/qBittorrent/complete/电影"
default_target_directory="/media/电影"
...
# 打印开始日志
log_message_with_level "INFO" "电影移动脚本开始运行"
...
# 打印结束日志
log_message_with_level "INFO" "电影移动脚本运行结束"